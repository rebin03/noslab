...
# Set the routing protocol to Link State
$ns rtproto LS
...
# Define a procedure to clean up and exit the simulation
proc finish {} {
    global ns nf nr
    $ns flush-trace
    close $nf
